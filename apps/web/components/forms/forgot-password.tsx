  ...
  return (
    <div className="h-full w-full">
      <div className="grid gap-2 mb-8 text-center">
        ...
        <p className="text-balance text-muted-foreground">Enter your email to recover an account</p>
      </div>
      <form className="bg-red-500" onSubmit={!successfulCreation ? create : reset}>
        ...
        {complete && "You successfully changed your password redirecting to signUp...."}
