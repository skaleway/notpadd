      ...
      <div className="pb-20 space-y-6">
        <MDXContent
          components={{
            ...
            p: ({ children }) => <p className="text-muted-foreground text-base/7">{children}</p>,
            pre: props => {
              return (
                <Code
            ...
            ul: ({ children }) => (
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">{children}</ul>
            ),
            ol: ({ children }) => (
              <ol className="list-decimal ml-5 space-y-8 text-muted-foreground">{children}</ol>
            ),
            li: ({ children }) => <li className="text-base/7 pl-1 space-y-6">{children}</li>,
            h1: ({ children }) => {
